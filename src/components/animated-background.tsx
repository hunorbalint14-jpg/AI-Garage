...
export function AnimatedBackground({
  ...
  return (
    <div
      ...
      aria-hidden
    >
      <div className="animate-blob absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full bg-green-900/40 blur-[120px]" />
      <div className="animate-blob animation-delay-2 absolute top-1/3 -right-40 h-[500px] w-[500px] rounded-full bg-emerald-900/30 blur-[100px]" />
      <div className="animate-blob animation-delay-4 absolute bottom-0 left-1/3 h-[400px] w-[400px] rounded-full bg-lime-900/25 blur-[80px]" />
      <Grid />
    </div>
  );
}
